...
const Dropdown = forwardRef(({ 
  ...
  return (
    <Menu as="div" className={cn('relative inline-block text-left', className)} ref={ref} {...props}>
      <div>
        <Menu.Button className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors" style={{
